...
namespace TopLearnDataLayer.Migrations
{
    ...
    [Migration("20230923102556_IsCurrectForAnswer")]
    partial class IsCurrectForAnswer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Order.Discount", b =>
                {
                    b.Property<int>("DisCountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DiscountPerecnt")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Order.Order", b =>
                {
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Order.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Question.Answer", b =>
                {
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Question.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopLearn.DataLayer.Entities.User.UserDiscount", b =>
                {
                    b.HasOne("TopLearnDataLayer.Entities.Order.Discount", "Discount")
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Order.OrderDetail", b =>
                {
                    ...
                    b.HasOne("TopLearnDataLayer.Entities.Order.Order", "Order")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("TopLearnDataLayer.Entities.Question.Answer", b =>
                {
                    b.HasOne("TopLearnDataLayer.Entities.Question.Question", "Question")
                        .WithMany("Answer")
